...
COMMON_APT_LISTS_DIR="$UBUNTU_DIR/common/apt-lists"
COMMON_POST_INSTALL_DIR="$UBUNTU_DIR/common/post-install.d"
...
rk_ubuntu_load_chip()
{
    ...
    RK_UBUNTU_USER="${RK_UBUNTU_USER:-ubuntu}"
    RK_UBUNTU_PASSWORD="${RK_UBUNTU_PASSWORD:-ubuntu}"
    ...
    RK_UBUNTU_COMMON_APT_LISTS_DIR="${RK_UBUNTU_COMMON_APT_LISTS_DIR:-$COMMON_APT_LISTS_DIR}"
    RK_UBUNTU_COMMON_POST_INSTALL_DIR="${RK_UBUNTU_COMMON_POST_INSTALL_DIR:-$COMMON_POST_INSTALL_DIR}"
    ...
    RK_UBUNTU_APT_LISTS_DIR="${RK_UBUNTU_APT_LISTS_DIR:-$RK_UBUNTU_CHIP_DIR/apt-lists}"
    RK_UBUNTU_POST_INSTALL_DIR="${RK_UBUNTU_POST_INSTALL_DIR:-$RK_UBUNTU_CHIP_DIR/post-install.d}"

    export RK_UBUNTU_CHIP RK_UBUNTU_CHIP_DIR RK_UBUNTU_HOSTNAME
    export RK_UBUNTU_USER RK_UBUNTU_PASSWORD
    ...
    export RK_UBUNTU_COMMON_APT_LISTS_DIR RK_UBUNTU_APT_LISTS_DIR
    export RK_UBUNTU_COMMON_POST_INSTALL_DIR RK_UBUNTU_POST_INSTALL_DIR
